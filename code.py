...
def generate_url(root_url, campaign_type, trigger_type, page_type, product, url_slug, offer_variant):
...
trigger_type = st.text_input("Trigger Type", value="savings-trigger", help="The type of trigger, e.g., 'savings-trigger', 'rps-trigger', 'checking-trigger', 'landing-page', etc.")
page_type = st.text_input("Page Type", value="business-checking", help="The type of page, e.g., 'business-checking', 'business-savings', etc.")
product = st.text_input("Product", value="", help="The specific product, e.g., 'business-essentials', 'silver-checking', etc.")
url_slug = st.text_input("URL Slug Descriptor", value="online-banking-offer", help="A descriptor for the URL slug, e.g., 'online-banking-offer', 'special-deal', 'promo', etc.")
...
if st.button("Generate URL"):
    campaign_url = generate_url(root_url, campaign_type, trigger_type, page_type, product, url_slug, offer_variant)
